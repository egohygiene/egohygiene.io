...
title: Ego Hygiene Website Design System
...
# Ego Hygiene Website Design System

## Purpose and scope

This document defines reusable semantic language for Ego Hygiene Website's documentation, terminal output, diagrams, reports, sites, and future interactive surfaces. It does not freeze a framework, component library, or final visual identity.
...
The expression should remain dark-cosmic, calm, inclusive, spacious, and capable of giving each product a distinct identity while allowing product-specific identity to vary inside Ego Hygiene's broader family.
