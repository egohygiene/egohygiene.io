...
id: website-ai-constitution
title: Ego Hygiene Website Ai Constitution
...
# Ego Hygiene Website AI Constitution

## Scope and authority

This constitution governs AI systems that inspect, author, validate, or operate on Ego Hygiene Website. Applicable law and platform safety requirements, organization policy, repository policy, accepted architecture, and explicit task authority take precedence over local prompts or model defaults.
...
AI may assist Ego Hygiene Website's systems—egohygiene.io application, Documentation application, Design playground, Shared UI and configuration packages, Static build, Routing and deployment adapters, Site analytics and health—but capability does not grant permission to operate them consequentially.
